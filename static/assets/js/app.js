(function () {
	...
	function initLanguage() {
        ...
        languages && Array.from(languages).forEach(function (dropdown) {
            dropdown.addEventListener("click", function (event) {
                ...
                $('#language_change').val(dropdown.getAttribute("data-lang"));
                $('#form_lang').submit();
            });
        });
	}
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/us.svg";
			} else if (lang == "es") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/spain.svg";
			} else if (lang == "ko") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/kr.svg";
			} else if (lang == "id") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/id.svg";
			} else if (lang == "mn") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/mn.svg";
			} else if (lang == "is") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/id.svg";
			} else if (lang == "vi") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/vn.svg";
			} else if (lang == "pt") {
				document.getElementById("header-lang-img").src = "/static/assets/images/flags/pt.svg";
			}
